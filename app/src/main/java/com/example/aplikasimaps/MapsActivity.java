...
import com.example.aplikasimaps.databinding.ActivityMapsBinding;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(-6.886864, 107.615309);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Ini Unikom"));
